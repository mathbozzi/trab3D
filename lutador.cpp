...
Lutador::Lutador(Point pos, float altura, float raio, Cor cor, GLfloat thetaLutador)
{
    this->centro = pos;
    this->cor = cor;
    this->raio = raio;
    ...
    //this->texturaLutador = LoadTextureRAW("/textura/lutador.bmp");
}
...
float Lutador::ObtemAltura()
{
    return this->altura;
}

float Lutador::ObtemCoordZ()
{
    return this->centro.z;
}

void Lutador::MudaCoordZ(float newz)
{
    this->centro.z = newz;
}

void Lutador::MudaAltura(float newaltura)
{
